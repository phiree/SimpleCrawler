...
namespace DiqudaimaParse
{
        ...
        public IList<AreaPostPhone> Parse(string sectionContent)
        {
            ...
            if (matches.Count == 2)
            {
                ...
                foreach (Match m2 in matchesSplit2)
                {
                    ...
                    results.Add(new AreaPostPhone { AreaCode =m2.Groups[2].Value 
                        , Name = m2.Groups[1].Value, PhoneCode = m2.Groups[4].Value, PostCode = m2.Groups[3].Value});
                }
            }
    ...
    //乡,镇
    public class SectionParser_Level3 : SectionParser
    {
        public IList<AreaPostPhone> Parse(string sectionContent)
        {
    ...
    //村
    public class SectionParser_Level4 : SectionParser
    {
        public IList<AreaPostPhone> Parse(string sectionContent)
        {
            throw new NotImplementedException();
